    ...
    Plugin.prototype.init = function () {
        ...
        this.headers = $elem.children('dt')
            ...
            .each(function (i, el) {
                ...
                $btn = $('<div/>').attr({
                    ...
                    'aria-expanded': 'false', // Initially set expanded to false
        ...
        this.panels = $elem.children('dd').each(function (i, el) {
            ...
            $me.attr({
                ...
                'aria-hidden': 'true', // Mark all panels as hidden by default
    ...
    Plugin.prototype.togglePanel = function (event) {
        ...
        if (plugin.options.autoCollapse) { // expand current panel and collapse the rest
            ...
            plugin.headers.each(function (i, el) {
                ...
                var $hdr = $(el);
                var $btn = $hdr.find('.button');
                var isCurrentTarget = $btn[0].id === event.currentTarget.id;
                var panelIsVisible = !!$hdr.next().is(':visible');

                if (!isCurrentTarget || panelIsVisible) {
